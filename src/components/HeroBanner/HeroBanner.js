    ...
    <>
      <div className=' bg-no-repeat  md:bg-cover w-full bg-right-top md:bg-center flex align-items-center z-0' style={{background: `url(${heroImg})`, height: '500px'}}>
        <div className="px-4  mx-4 lg:px-4 lg:mx-6 pb-4 lg:pb-4">
            <span className="block text-3xl font-bold text-6xl line-height-2" style={{color: '#1F1F1F'}}>Support Your Local Artisans</span>
            <span className="block text-4xl font-medium text-color text-2xl font-light line-height-2" style={{color: '#1F1F1F'}}>Discover brands and theit stories</span>
