...
export const Contacto = () => {
  ...
  return (
    ...
    data-aos-duration="2000" id="contacto" className="flex flex-column m-3 h-full justify-content-center bg-green-500">
      ...
      <form ref={form} onSubmit={sendEmail} className="flex flex-column justify-content-center align-items-center p-1 mt-2 border-round">
        <div className="flex flex-column py-3 col-12 md:col-6 lg:col-6">
          <span className="p-float-label p-input-icon-right">
            <InputText name="name" className="w-12 " pattern="^[A-Za-zÑñÁáÉéÍíÓóÚúÜü\s]+$" required/>
        ...
        <div  className="flex flex-column py-3 col-12 md:col-6 lg:col-6">
        <span className="p-float-label p-input-icon-right">
            <InputText name="email" className="w-12" pattern="^[a-z0-9]+(\.[_a-z0-9]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,15})$" required/>
        ...
        <span className="p-float-label">
            <InputTextarea name="message" className="w-12" style={{resize:"none", height:"150px"}} required />
